  ...
  return (
    <div id="about">
      ...
      <section className="intro">
        <p>
          Hi, I'm <strong>Abdul Raheem Khan</strong>, A passionate and dedicated web developer with hands-on experience in building responsive, full-stack web applications
using HTML, CSS, JavaScript, Node.js, Express.js, MongoDB and ReactJS. Skilled in creating clean, user-friendly
interfaces and efficient backend systems, with a focus on RESTful APIs and user authentication. Eager to apply my
knowledge and creativity to develop innovative solutions and contribute to impactful projects
          <br/>
        </p>
      </section>
